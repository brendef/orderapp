    ...
    <div className="flex max-w-md mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
        ...
        <div className="w-2/3 p-4 md:p-4">
            ...
            <div className="flex justify-between mt-5 item-center">
                <h1 className="text-3xl mt-1 font-bold text-gray-700 dark:text-gray-200 md:text-2xl">R220</h1>
                <button className="px-4 py-3 text-xs font-bold text-white uppercase transition-colors duration-200 transform bg-gray-800 rounded dark:bg-gray-700 hover:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:bg-gray-700 dark:focus:bg-gray-600">Add to Cart</button>
            </div>
        </div>
    </div>
  )
